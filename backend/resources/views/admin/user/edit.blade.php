    ...
    <form action="{{ route('admin.user.update', $user->id) }}" method="POST">
        ...
        <div class="mb-4">
            <label class="block text-gray-700 text-sm font-semibold mb-2">Password Baru
                <span class="text-xs text-gray-400 font-normal">(Kosongkan jika tidak ingin merubah password)</span></label>
        ...
        <div class="flex justify-end space-x-2">
            <a href="{{ route('admin.user.index') }}"
                class="bg-gray-300 hoover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg text-sm font-semmibold transition"> Batal</a>
            <button type="submit"
