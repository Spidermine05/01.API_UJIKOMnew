            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="text-gray-700 text-sm">
                    @forelse($users as $user)
                        ...
                        <td class="py-3 px-4 border-b text-gray-500">{{ $user->id }}</td>
                            <td class="py-3 px-4 border-b">
                                @if($user->foto_profile)
                                    <img src="{{ asset($user->foto_profile) }}" alt="Foto {{ $user->name }}" class="w-9 h-9 rounded-full object-cover border border-gray-200">
                                @else
                                    <span class="w-9 h-9 rounded-full bg-gray-200 text-gray-500 flex items-center justify-center text-xs font-semibold">
